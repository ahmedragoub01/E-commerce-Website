...
import { Package, CheckCircle, Clock, ShoppingCart, XCircle, ChevronLeft, Printer } from "lucide-react";
            ...
            <Card className="p-8 shadow-lg border rounded-2xl bg-white overflow-hidden">
                <div className="space-y-6">
                    <div className="flex justify-between items-center">
                        ...
                        <Button
                            onClick={handlePrint}
                            className="bg-indigo-600 hover:bg-blue-600 text-white text-sm px-4 py-2 flex items-center gap-2"
                        >
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <p className="text-lg font-medium text-gray-800">{order.status}</p>
                        </div>
                    </div>
                    <Separator className="my-4" />
                    <div>
                    ...
                    <div>
                        ...
                        <div className="mt-4">
                            <div className="flex justify-between">
                                ...
                                <p className="text-gray-800">${order.total * 0.9}</p>
                            </div>
                            <div className="flex justify-between">
                                <p className="text-gray-600">Shipping</p>
                                <p className="text-gray-800">${order.shipping || "5.00"}</p>
                            </div>
